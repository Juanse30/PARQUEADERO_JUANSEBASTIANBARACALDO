...
public class Parqueadero {
     ...
     *
     * @return Retorna la placa del carro con mas tiempo en el parqueadero.
     */
    public String metodo1() {

        //El carro con mas tiempo
        int nMayor = 0;
        int pCarro = 0;
        String sinCarros = "El parqueadero no tiene carros";
        for (int i = 0; i < TAMANO; i++) {
            if (estaOcupado(i)) {
                sinCarros = "";
                Carro carro = puestos[i].darCarro();
                int nTiempo = carro.darTiempoEnParqueadero(horaActual);
        ...
        String maxTiempo = darPlacaCarro(pCarro);
        maxTiempo = maxTiempo.replaceFirst("Placa: ", "");
        if(!sinCarros.equals("")){
            return sinCarros;
        }
        return "El carro con mas tiempo es " + maxTiempo;
     ...
     *
     * @return Retorna si hay puestos disponibles o si el parqueadero esta lleno.
     */
